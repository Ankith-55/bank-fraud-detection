    ...
    async def send_email(
        ...
        try:
            ...
            if not cls.template_name or not cls.template_name_plain:
                raise ValueError("Both HTML and plain text templates are required.")
            ...
            logger.error(f"Failed to queue email for {recipient_list}: Error: {str(e)}")
            raise 
